/*************************************************
File name:axi4_m_readop_test.sv
Description:

**************************************************/
class axi4_m_readop_test extends axi4_m_base_test;
 
  `uvm_component_utils(axi4_m_readop_test)
     
  //constructor
  function new(string name = "axi4_m_readop_test",uvm_component parent=null);
...
/************************************************************************/
    ...
    // master_wburst = 0(fixed burst) / 1(increment burst) / 2(wrap burst)
