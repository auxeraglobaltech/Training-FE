/*************************************************
File name:axi4_m_writeop_deviceidfailure_test.sv
Description:

**************************************************/
class axi4_m_writeop_deviceidfailure_test extends axi4_m_base_test;
 
  `uvm_component_utils(axi4_m_writeop_deviceidfailure_test)
 
  //constructor
  function new(string name = "axi4_m_writeop_deviceidfailure_test",uvm_component parent=null);
