...
`endif
    ...
    // ------------------------------------------------------------------------
    // [dv/shim] Xcelium: forward-declare pipe_stall (declare-before-use);
    // assigned below where its operands exist.
    wire pipe_stall;
    ...
    assign pipe_stall = crsp_queue_stall || amo_chain_stall; // [dv/shim] was wire decl
